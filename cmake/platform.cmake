# CopyRight (c) 2020 ByteDance Inc. All Right Reserved. Platform check Export
# Cache Variables(access vir get_cache): HOST_WINDOWS: BOOL HOST_MACOS: BOOL
# HOST_LINUX: BOOL PLATFORM: string, input from command line or auto select
# according to the host(ios,macos,android,unity,linux,win,windows) PLATFORM_IOS:
# BOOL PLATFORM_MAC: BOOL PLATFORM_APPLE: BOOL PLATFORM_ANDROID: BOOL
# PLATFORM_WINDOWS: BOOL PLATFORM_LINUX: BOOL PLATFORM_UNITY: BOOL
# ARCHITECTURE_NAME: string, define by HOST_<PLATFORM> RUNTIME_NAME: string,
# example: powershell bash zsh and so on
...
if(ANDROID)
  ...
  if(HOST_MACOS AND (NOT TARGET_PLATFORM))
    message(STATUS "not specified platform, guess to create macos")
    set(TARGET_PLATFORM "macos")
  endif()

  # Current host is mac osx, and not compile android, not select ios or mac,
  # which should be an fatal error
  if(HOST_MACOS
     AND (NOT "x${TARGET_PLATFORM}" STREQUAL "xios")
     AND (NOT "x${TARGET_PLATFORM}" STREQUAL "xmacos")
     AND (NOT "x${TARGET_PLATFORM}" STREQUAL "xmac")
     AND (NOT "x${TARGET_PLATFORM}" STREQUAL "xandroid"))
    message(FATAL_ERROR "Please set TARGET_PLATFORM as ios or macos")
  endif()
endif()
...
if("x${TARGET_PLATFORM}" STREQUAL "xios")
  set(PLATFORM_IOS TRUE)
  set(PLATFORM_APPLE TRUE)
  set(PLATFORM_POSIX TRUE)
  add_definitions(-DPLATFORM_IOS=1)
elseif(("x${TARGET_PLATFORM}" STREQUAL "xmacos") OR ("x${TARGET_PLATFORM}" STREQUAL "xmac"))
  set(TARGET_PLATFORM "macos")
  set(PLATFORM_MAC TRUE)
  set(PLATFORM_APPLE TRUE)
  set(PLATFORM_POSIX TRUE)
  add_definitions(-DPLATFORM_MAC=1)
elseif("x${TARGET_PLATFORM}" STREQUAL "xandroid")
  set(PLATFORM_ANDROID TRUE)
  set(PLATFORM_POSIX TRUE)
  add_definitions(-DPLATFORM_ANDROID=1)
elseif(("x${TARGET_PLATFORM}" STREQUAL "xwindows") OR ("x${TARGET_PLATFORM}" STREQUAL "xwin"))
...
message(STATUS "CURRENT HOST: ${CMAKE_HOST_SYSTEM_NAME}")
message(STATUS "CURRENT_ARCHITECTURE_NAME: ${ARCHITECTURE_NAME}")
